...
<!-- Start Hero -->
  <div class="cs-hero cs-style1 cs-type1 text-center" id="home">
    ...
    <div class="cs-slider cs-style1">
      <div class="cs-slider_container" data-autoplay="1" data-loop="1" data-speed="2000" data-center="0" data-fade-slide="1" data-slides-per-view="1">
        <div class="cs-slider_wrapper">
          ...
          <div class="cs-slide">
            <div class="cs-hero_slide cs-fixed_bg cs-bg" data-src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/Blue-Numbers-AdobeStock_87781321-02-25-21-scaled.jpg"></div>
          </div><!-- .cs-slide -->
          <div class="cs-slide">
    ...
    <div class="container">
      <div class="cs-hero_text">
        <h1 class="cs-hero_title wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
          We Are <span class="cs-accent_color">GAVAWEB</span>.com <br>Digital Agency
        </h1>
        ...
        <div class="cs-hero_info">
            ...
            <div>
              <div class="cs-hero_subtitle">We create high-performing websites and digital marketing strategies that boost your business</div>
            </div>
        </div>
      </div>
    </div>
    <div class="cs-hero_social_wrap cs-primary_font cs-primary_color">
      ...
      <ul class="cs-hero_social_links">
        <li><a href="https://www.facebook.com/gavawebmarketing/" target="_blank" >Facebook</a></li>
        <li><a href="https://www.instagram.com/gavaweb/" target="_blank" >Instagram</a></li>
      </ul>
    </div>
    <div class="cs-hero_social_wrap cs-left_side cs-primary_font cs-primary_color">
      <ul class="cs-hero_social_links">
        <li><a href="mailto:info@gavaweb.com"><span class="__cf_email__" target="_blank" data-cfemail="51383f373e113023383f3e7f323e3c">info@gavaweb.com</span></a></li>
    ...
    <div class="container">
      <div class="cs-funfact_wrap_2 cs-type1">
        ...
        <div class="cs-funfacts">
          ...
          <div>
            <div class="cs-funfact cs-style2">
              <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color"><span data-count-to="115" class="odometer"></span> <span class="cs-plus">+</span></div>
          ...
          <div>
            <div class="cs-funfact cs-style2">
              <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color"><span data-count-to="3600" class="odometer"></span> <span class="cs-plus">+</span></div>
              <h3 class="cs-funfact_title">Cofee with clients</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="service">
    ...
    <div class="cs-moving_text_wrap cs-type1 cs-bold cs-primary_font">
      <div class="cs-moving_text_in">
        <div class="cs-moving_text"><a href="#">UI/UX Design</a>-<a href="#">Marketing</a>-<a href="#">Branding</a>-</div>
        <div class="cs-moving_text"><a href="#">UI/UX Design</a>-<a href="#">Marketing</a>-<a href="#">Branding</a>-</div>
      </div>
    </div>
  ...
  <section class="cs-shape_wrap_4 cs-parallax">
    <div class="cs-shape_4 cs-to_up" style="background:#ff0044"></div>
    <div class="cs-shape_4 cs-to_right" style="background:#ff0044"></div>
    <div class="cs-height_150 cs-height_lg_80"></div>
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-xl-4">
          <div class="cs-section_heading cs-style1">
            ...
            <div class="cs-hero_info">
              <div>
                <div class="cs-hero_subtitle">We are a team of web development experts with a special focus on creating custom and complex WordPress sites. We combine cutting-edge technology with digital marketing strategies to offer you complete solutions that guarantee measurable results.</div>
              </div>
            </div>

            <div class="cs-height_45 cs-height_lg_20"></div>
            <a href="<?php echo home_url('/about/'); ?>" class="cs-text_btn wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
        ...
        <div class="col-lg-7 offset-xl-1">
          <div class="cs-half_screen">
            <a href="https://www.youtube.com/watch?v=Nxq3Ja_6ldY" class="cs-video_block cs-style1 cs-size1 cs-video_open cs-bg" data-src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/video_bg.jpg">
          ...
          <div class="slider-nav cs-style1">
              ...
              <div class="slider-nav_item">
                <div class="cs-rotate_img">
                  <div class="cs-rotate_img_in">
                    <img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/testimonial_1.jpg" alt="Nav Image">
                  </div>
                </div>
              </div>
            </div>
            <div class="slider-for_item item-nav">
              <div class="slider-nav_item">
                <div class="cs-rotate_img">
                  <div class="cs-rotate_img_in">
                    <img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/testimonial_2.jpg" alt="Nav Image">
                  </div>
                </div>
              </div>
            </div>
            <div class="slider-for_item item-nav">
              <div class="slider-nav_item">
                <div class="cs-rotate_img">
                  <div class="cs-rotate_img_in">
                    <img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/testimonial_3.jpg" alt="Nav Image">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/rating.svg"></div>
                  <div class="cs-rating_percentage" data-src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/rating.svg"></div>
                </div>
  ...
  <div class="container">
    ...
    <div class="cs-partner_logo_wrap">
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_6.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_7.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_8.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_9.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_10.svg" alt="Partner"></div>
    </div>
    <div class="cs-height_35 cs-height_lg_0"></div>
    <div class="cs-partner_logo_wrap">
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_11.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_12.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_13.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_14.svg" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/partner_15.svg" alt="Partner"></div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1" data-src="<?php echo get_bloginfo( 'template_directory' );?>/assets/img/cta_bg.jpg" >
        ...
        <div class="cs-cta_in">
          ...
          <a href="https://wa.me/5492804341440?text=I'm%20interested%20in%20your%20web%20services" class="cs-text_btn wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
