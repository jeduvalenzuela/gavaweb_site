          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs-footer_item">
              ...
              <div class="cs-social_btns cs-style1">
                <a href="https://linkedin.com/company/gavaweb-com" target="_blank" class="cs-center">
                ...
                <a href="https://twitter.com/gavawebmarketin" target="_blank" class="cs-center">
                ...
                <a href="https://www.youtube.com/channel/UCeunoBGn1nCXXfaFjh0wXqw" target="_blank" class="cs-center">
                ...
                <a href="https://join.slack.com/t/gavawebespacio/shared_invite/zt-2drdvwfo0-bVOirRIJ65q2yswofrOZ~Q" target="_blank" class="cs-center">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs-footer_item">
              ...
              <div class="cs-newsletter cs-style1">
                ...
                <div class="cs-newsletter_text">Leave us your email to receive our news and promotions.</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="cs-bottom_footer">
        <div class="cs-bottom_footer_left">
          <div class="cs-copyright">Copyright © 2024 GAVAWEB.com.</div>
        </div>
...
|</style>
<a href="https://api.whatsapp.com/send?phone=5491144799223&text=I'm%20interested%20in%20your%20web%20services." class="float" target="_blank">
    <i class="fab fa-whatsapp my-float"></i>
</a>

  <!-- Script -->
  <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
  <script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/plugins/jquery-3.6.0.min.js"></script>
  <script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/plugins/isotope.pkg.min.js"></script>
  <script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/plugins/jquery.slick.min.js"></script>
  <script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/plugins/jquery.counter.min.js"></script>
  <script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/plugins/lightgallery.min.js"></script>
